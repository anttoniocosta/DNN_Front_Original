      ...
      bodyChild: Column(
        ...
        children: [
          ...
          SpecialistCard(
            ...
            isSelected: true,
            crmNumber: specialist!.doctor!.crmNumber,
            clinicName: specialist!.clinic!.fullName!.capitalize,
            price: specialist!.price!.toString(),
            fullName: specialist!.doctor!.fullName!.capitalize,
            specialty: specialist!.specialtyName!.capitalize,
          ),
          24.heightGap,
          Text(
            contentTitle,
