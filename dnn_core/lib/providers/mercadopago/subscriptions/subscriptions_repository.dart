...
import 'package:dnn_core/providers/mercadopago/subscriptions/subscriptions_model.dart';
...
class SubscriptionsRepository {
  ...
  SubscriptionsRepository(
      {required this.acessToken, required this.notificationUrl});
