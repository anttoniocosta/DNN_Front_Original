import 'package:dnn_app/core/core.dart';
...
class _MyAppState extends State<MyApp> {
  final RouteObserverMiddleware _routeObserverMiddleware =
      RouteObserverMiddleware();
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) {
        return GetMaterialApp(
          ...
          navigatorObservers: [_routeObserverMiddleware],
